...
begin
   ...
   DB.FDQueryPedidos.FieldByName('data_do_pedido').AsDateTime := now();
   ...
   DB.FDQueryItemPedido.FieldByName('id_pedido').AsInteger :=
   DB.FDQueryPedidos.FieldByName('id').AsInteger;
   DB.FDQueryItemPedido.FieldByName('id_produto').AsInteger :=
   DB.FDQueryProduto.FieldByName('id').AsInteger;
   DB.FDQueryItemPedido.FieldByName('qte_produto').AsInteger :=
   DB.FDQueryItemPedido.FieldByName('qte_produto').AsInteger + 1;
   DB.FDQueryItemPedido.FieldByName('vlr_item').AsFloat :=
   DB.FDQueryProdutovalor.AsFloat;
   DB.FDQueryItemPedido.Post;
   ShowMessage('Item adicionado ao pedido!');
